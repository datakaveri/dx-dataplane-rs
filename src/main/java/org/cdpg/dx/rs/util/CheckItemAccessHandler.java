            ...
            resp -> {
              ...
              if (resp.statusCode() == 200) {
                ...
                if (resultObj != null && !resultObj.isEmpty()) {
                  isOpen =
                      resultObj.containsKey("accessPolicy")
                          && resultObj.getString("accessPolicy").equals(accessPolicy);
    ...
    webClient
        ...
        .onFailure(
            err ->
                promise.fail(
                    new DxInternalServerErrorException(
                        "Access check request failed: " + err.getMessage())));
    return promise.future();
  }
}
