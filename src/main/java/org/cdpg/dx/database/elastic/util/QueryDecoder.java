...
////    Query idTermsQuery = TermsQuery.of(query ->
// query.field("id").terms(termQueryField))._toQuery();
...
//      }
//      queryDecorator =
//              new TemporalQueryFiltersDecorator(queryLists, jsonQuery,
// defaultDateForDevDeployment);
//      queryDecorator.add();
//      temporalQuery = true;
//      isValidQuery = true;
//    }
