...
public class ApplicableFilterNGSILD implements Handler<RoutingContext> {
  private static final Logger LOGGER = LogManager.getLogger(ApplicableFilterNGSILD.class);
  private final WebClient webClient;
  private final String checkItemAndFilterUrl;

  public ApplicableFilterNGSILD(String controlPlaneDomain) {
