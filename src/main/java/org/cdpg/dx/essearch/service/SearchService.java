...
public interface SearchService {
  ...
  Future<List<ElasticsearchResponse>> searchAllData(String index, int size, int page, String sortBy, String sortOrder);

  Future<ReadStream<Buffer>> streamAllData(String index, int size, int page, String sortBy, String sortOrder);
